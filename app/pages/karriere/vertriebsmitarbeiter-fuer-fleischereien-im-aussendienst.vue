<template>
    <SectionHero title="Vertriebsmitarbeiter für Fleischereien im Außendienst"
    ...
    <SectionText>
        ...
        <div class="formatted-content">
            ...
            <p>Zur Verstärkung unseres Verkaufsteams suchen wir zum nächstmöglichen Zeitpunkt einen
            </p>
            ...
            <ul class="list-disc pl-6 mt-4">
                <li>
                    <p>Akquisition von Neukundenim Bereich Fleischereien</p>
                </li>
                <li>
                    <p>Betreuung eines festen Verkaufsgebietes</p>
                </li>
                <li>
            ...
            <ul class="list-disc pl-6 mt-4">
                ...
                <li>
                    <p>Viele weitere Mitarbeitervorteile (z. B. Rabatte auf unsere
                        Handelsprodukte, Dienstradleasing, Corporate Benefits, Teamevents)</p>
                </li>
            </ul>
...
definePageMeta({
    title: 'Vertriebsmitarbeiter für Fleischereien im Außendienst',
