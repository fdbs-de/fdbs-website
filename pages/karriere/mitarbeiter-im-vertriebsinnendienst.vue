<template>
    <SectionHero title="Mitarbeiter im Vertriebsinnendienst in Vollzeit"
    ...
    <SectionText>
        ...
        <div class="formatted-content">
            ...
            <ul>
                <li>
                    <p>Betreuung unserer Key-Account-Kunden</p>
                </li>
                <li>
                ...
                <li>
                    <p>Du agierst als Schnittstelle zwischen unseren Kunden, dem Außendienst und den Belieferungsabteilungen
                    </p>
                </li>
                <li>
...
definePageMeta({
    title: 'Mitarbeiter im Vertriebsinnendienst in Vollzeit',
    description: 'Vollzeit, Vertrieb, Innendienst',
})
