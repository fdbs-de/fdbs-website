<template>
    ...
    <SectionText>
        ...
        <span>
            ...
            Tags: <b>Marketing, Kommunikation</b>
        </span>
        <HeDivider />
        <div class="formatted-content">
            ...
            <div icon="star" class="key-fact"><span class="icon" data-icon="star" contenteditable="false"></span>
                <div class="content">
                    <p><span style="color: rgb(104, 111, 111)">Bei Problemen oder Unklarheiten, wende dich gerne an die
                            IT oder das Marketing.</span></p>
                </div>
            </div>
            <p></p>
            <p></p>
            <h1>Einrichtung von WhatsApp Business</h1>
            <p><span style="color: var(--color-text-soft)">Die App wird durch die IT autoamtisch auf das Handy gespielt.
                    Es erscheint ein Pop-Up mit einem Hinweis. Danach wird die App installiert.</span></p>
            ...
            <div icon="star" class="key-fact"><span class="icon" data-icon="star" contenteditable="false"></span>
                <div class="content">
                    <p><span style="color: rgb(104, 111, 111)">WhatsApp Business funktioniert grundsätzlich wie das
                            herkömmliche WhatsApp. Zusätzlich bietet es jedoch einige nützliche Funktionen speziell für
                            Unternehmen, wie Labels, Schnellantworten oder einen Produktkatalog. So wird die
                            Kundenkommunikation effizienter, strukturierter und professioneller gestaltet.</span></p>
                </div>
            </div>
            <p></p>
            <p></p>
