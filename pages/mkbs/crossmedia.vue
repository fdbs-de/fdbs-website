<template>
    <SectionHero image="/images/content/mkbs/banner/header_cossmedia_292968998.png" large-hero />
    <SectionKeyfacts :keyfacts="keyfacts" title="Unsere Leistungen im Überblick" color="#20bf6b" accent-color="#20bf6b30"/>
    <SectionText>
        <h1>Unsere Leistungen im Crossmedia Marketing</h1>
        <br>

        <h2>Klassische Werbemittel</h2>
        <img src="/images/content/mkbs/leistungen/adwork/classic_products.png" alt="" class="rounded-lg mb-8">
        <p>
            ...
            und Herstellung individueller und somit verkaufsfördernder Verpackungen: Entsprechend Ihrer Wünsche können Sie bei uns
        ...
        <h2>Außenwerbung</h2>
        <img src="/images/content/mkbs/leistungen/adwork/outdoor.png" alt="" class="rounded-lg mb-8">
        <p>
        ...
        <img src="/images/content/mkbs/leistungen/adwork/assembly.png" alt="" class="rounded-lg mb-8">
        <p>
        ...
        <img src="/images/content/mkbs/leistungen/digital_marketing/digital_signage.png" alt="" class="rounded-lg mb-8">
        <p>
            ...
            oder Tagesmenüs aufmerksam machen. Dies ermöglicht es Ihnen dabei flexibel auf aktuelle Gegebenheiten wie
            Preisänderungen oder Sonderaktionen einzugehen, indem Sie auch spontan Änderungen an den Inhalten vornehmen können. Wir
        ...
        <img src="/images/content/mkbs/leistungen/digital_marketing/addressable_tv.png" alt="" class="rounded-lg mb-8">
        <p>
            ...
            ausgestrahlt werden kann an. Somit erreichen Ihre Anzeigen auch tatsächlich Kunden in Ihrer Umgebung. Gleichzeitig
            können Sie die Zielgruppe Ihrer Werbung noch individuell definieren und verfeinern, etwa was Altersgruppe, Thema der
        ...
        <img src="/images/content/mkbs/leistungen/digital_marketing/photo_and_video.png" alt="" class="rounded-lg mb-8">
        <p>
            ...
            dessen Fertigstellung. Dabei gehen wir gezielt auf Ihre individuellen Wünsche und Vorschläge ein, um als Ergebnis eine
            bestmögliche Repräsentation Ihres Unternehmens zu erhalten. Zudem bieten wir das dafür benötigte Equipment und sind auch
        ...
        <img src="/images/content/mkbs/leistungen/online_marketing/marketing_package.png" alt="" class="rounded-lg mb-8">
        <p>
            ...
            Mit Hilfe unseres jungen, kompetenten Teams können Sie ansprechende, individuelle Anzeigen für Display Ads auf
            verschiedensten Webseiten entwickeln. So können Sie durch die Reichweite des Internet frühzeitig Kunden für sich
        ...
        <img src="/images/content/mkbs/leistungen/online_marketing/content_marketing.png" alt="" class="rounded-lg mb-8">
        <p>
            ...
            konsistenten Inhalten und Veröffentlichung, zum Beispiel auf dem Blog Ihres Unternehmens. So informieren Sie Kunden über
        ...
        <h2>Recruiting</h2>
        <img src="/images/content/mkbs/leistungen/online_marketing/recruiting.png" alt="" class="rounded-lg mb-8">
        <p>
            ...
            Printmedien, Fernseh- oder Radiospots, ebenso wie Anzeigen für eine definierte Zielgruppe in den sozialen Medien (ganz
            ohne dafür einen eigenen Account erstellen zu müssen) für Sie erstellen. Diese werden so kombiniert, wie es für Ihr
            Unternehmen am erfolgversprechendsten ist.<br><br>
        </p>
        <p>
